...
t_axis = csvread( strcat( 't_axis' , idx , '.csv' ) );
x_Bx = csvread( strcat( 'x_Bx' , idx , '.csv' ) );
x_By = csvread( strcat( 'x_By' , idx , '.csv' ) );
theta_B_PID = csvread( strcat( 'theta_B_PID' , idx , '.csv' ) );
theta_B_iLQR = csvread( strcat( 'theta_B_iLQR' , idx , '.csv' ) );
x_mB_PID = csvread( strcat( 'x_mB_PID' , idx , '.csv' ) );
x_mB_iLQR = csvread( strcat( 'x_mB_iLQR' , idx , '.csv' ) );
